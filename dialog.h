...
public:
    ...
    std::unordered_map<std::string, std::variant<QTextEdit*, QLineEdit*, QPushButton*>> elements;
...
public:
    ...
    void setComponentsStatus_(std::variant<QTextEdit*, QLineEdit*, QPushButton*> tem, bool status) {
...
private:
    Components<QTextEdit, QPushButton> tes{"TextEdit_1", "pushButton_1"};
